...
import { BitpayService } from "services/bitpay.service";

@Global()
@Module({
  imports: [HttpModule],
  providers: [EasypayService, RequestService, VerifyService, ZibalService, ZarinpalService, UrlService, ErrorService, NovinpalService, BitpayService],
